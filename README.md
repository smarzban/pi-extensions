...
| [pi-stash](packages/pi-stash) | [`@pi-extensions/pi-stash`](https://www.npmjs.com/package/@pi-extensions/pi-stash) | Draft stash: ctrl+s saves/restores the editor draft per project |
